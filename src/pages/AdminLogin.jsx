...
const AdminLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://usamaportfolio-backend-production.up.railway.app/api/admin/login', {
                method: 'POST',
                headers: {
            ...
            <div className="flex-1 flex items-center justify-center px-4">
                <div className="max-w-xs w-full">
                    <div className="bg-[var(--card-bg)] rounded-xl p-5 border border-[var(--border-color)] shadow-xl">
                        ...
                        <a
                            href="https://usamaportfolio-backend-production.up.railway.app/api/admin/auth/google"
